...
export default function EditPublicInfo() {
    ...
    return (
        <div className="container" style={{maxWidth: 2000, height: '100vh'}}>
            <div className="title" style={{paddingTop: 30}}>
                <h1>Edit public information member {id_obj.id}</h1>
            </div>
            ...
            <div className='input-content' style={{width: 800, margin: '0 auto', marginTop: 30}}>
                ...
                <div className="input-group mb-3">
                    ...
                    <input defaultValue={member.name} type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"/> <br/>
                </div>

                <div className="input-group mb-3">
                    <span style={spanStyle} className="input-group-text" id="inputGroup-sizing-default">Phone number</span>
                    <input defaultValue={member.phone_number} type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"/> <br/>
                </div>

                <div className="input-group mb-3">
                    <span style={spanStyle} className="input-group-text" id="inputGroup-sizing-default">Email</span>
                    <input defaultValue={member.address} type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default"/> <br/>
                </div>
            </div>
            
            <div className='groupButton' style={{marginTop: 50}}>
                <Link style={{textDecoration: "none", marginRight:80}} to={`/dashboard/publicInfo/`}>
