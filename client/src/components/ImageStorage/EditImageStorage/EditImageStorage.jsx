...
export default function EditImageStorage() {
    const spanStyle = {
        width: 130,
        display: 'flex',
    ...
    useEffect(() => {
        let image = JsonData.filter((image) => image.id == objId.id)[0];
        setImage(image);
    });
    ...
    return (
        <div className="container" style={{ maxWidth: 2000, height: '100vh' }}>
            <div className='title' style={pathStyle}>
                ...
                <h1 style={{ color: '#1570EF', fontWeight: 'bold' }}>Edit Image Storage</h1>
            </div>
            ...
            <div className='input-content' style={{ width: 800, margin: '0 auto', marginTop: 30 }}>
                <div className="input-group mb-3">
                    ...
                    <input defaultValue={image.id} disabled type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" />
                    <br />
                </div>
                <div className="input-group mb-3">
                    <span style={spanStyle} className="input-group-text" id="inputGroup-sizing-default">Url</span>
                    <input defaultValue={image.url} type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" />
                    <br />
                </div>
                <div className="input-group mb-3">
                    <span style={spanStyle} className="input-group-text" id="inputGroup-sizing-default">ID Admin</span>
                    <input defaultValue={image.id_admin} disabled type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" />
                    <br />
                </div>
